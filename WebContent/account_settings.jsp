			...
			<div class="row">
				...
				<div class="col-sm-8">
					<form class="form" id="form" action="" method="post">
                        ...
                        <input type="text" name="fname" placeholder="${first}" value="${first}" id="fname" class="form-field"><br>
                        <label for="lname" class="form-field">Change Last Name</label>
                        <input type="text" name="lname" placeholder="${last}" value="${last}"  id="lname" class="form-field"><br>
