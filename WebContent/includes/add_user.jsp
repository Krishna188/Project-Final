        ...
        <section class="col-sm-8">
            <fieldset>
                <div class="form-group">
                    <label for="" class="label label-info form-control">Role</label>
                    <select name="role">
                ...
                <div class="form-group">
                    ...
                    <button type="reset" onclick="document.getElementById('add_user').reset();" class="btn-warning">Clear</button>
                </div>
            </fieldset>
        </section>
    </form>
